    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AccountMember>(entity =>
        {
            ...
            entity.HasOne(d => d.MemberRoleNavigation).WithMany(p => p.AccountMembers)
                ...
                .HasConstraintName("FK_AccountMember_Role");
        });

        modelBuilder.Entity<Country>(entity =>
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Countrie__10D160BF766F36D2");
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__Employee__7AD04FF12DCE94DA");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__Jobs__056690E222CFED1C");
        ...
        {
            entity.HasKey(e => e.LocationId).HasName("PK__Location__E7FEA477D92A4E78");
        ...
        {
            entity.HasKey(e => e.RegionId).HasName("PK__Regions__ACD84443CE177FD8");
